...
function getSuggestionsByCategory(category) {
    const suggestions = {
        design: [
            'NFT 아트 디자인 의뢰하고 싶어요.',
            '정월 맞고 응답 베털 전문가에게 웹사이트 UI 디자인 의뢰하고 싶어요.',
            '포트폴리오를 위한땀 수 있는 AI 디자인 서비스 추천해주세요',
            '100만 원 내 메타버스 앱 디자인 서비스 찾기',
            '검증된 간판 디자인 서비스 추천',
            '의류 디자인을 전문으로 하는 디자이너를 찾고 있어요.'
        ],
        marketing: [
            'SNS 마케팅 전문가를 찾고 있어요.',
            '온라인 광고 운영을 도와줄 분을 찾아요.',
            '브랜드 마케팅 전략을 세우고 싶어요.',
            '인플루언서 마케팅 진행하고 싶어요.',
            '콘텐츠 마케팅 기획이 필요해요.',
            '이메일 마케팅 캠페인을 만들고 싶어요.'
        ],
        programming: [
            '웹사이트 개발을 의뢰하고 싶어요.',
            '모바일 앱 개발이 필요해요.',
