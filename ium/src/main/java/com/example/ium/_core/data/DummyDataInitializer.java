...
public class DummyDataInitializer {
    ...
    private List<Member> createMembers() {
        ...
        // 전체 32명을 전문가로 생성 (기본 테스트 계정 2개 + 각 분야별 6명씩 30명)
        String[] usernames = {
            "USERNAME1", "USERNAME2", // 기본 테스트 계정 2개
            // 프로그래밍 (0-5) - 6명
            "프론트엔드개발자", "백엔드개발자", "풀스택개발자", "모바일개발자", "AI개발자", "블록체인개발자",
            // 디자인 (6-11) - 6명
            "UI디자이너", "UX디자이너", "브랜드디자이너", "그래픽디자이너", "웹디자이너", "3D디자이너",
            // 영상편집 (12-17) - 6명
            "영상편집러", "유튜브편집러", "모션그래픽러", "드론촬영가", "웨딩영상가", "방송엔지니어",
            // 세무/법무/노무 (18-23) - 6명
            "공인회계사", "변호사", "노무사", "세무사", "변리사", "기업법무",
            // 번역/통역 (24-29) - 6명
            "다국어번역가", "비즈니스통역사", "기술번역가", "의학번역가", "게임번역가", "법무번역가"
        };
        
        String[] emailPrefixes = {
            "user1", "user2", // 기본 테스트 계정 이메일
            // 프로그래밍 (0-5) - 6명
            "frontend_dev", "backend_dev", "fullstack_dev", "mobile_dev", "ai_developer", "blockchain_dev",
            // 디자인 (6-11) - 6명
            "ui_designer", "ux_designer", "brand_designer", "graphic_designer", "web_designer", "3d_designer",
            // 영상편집 (12-17) - 6명
            "video_editor", "youtube_editor", "motion_graphic", "drone_pilot", "wedding_videographer", "broadcast_engineer",
            // 세무/법무/노무 (18-23) - 6명
            "cpa_accountant", "lawyer", "labor_consultant", "tax_accountant", "patent_attorney", "corporate_legal",
            // 번역/통역 (24-29) - 6명
            "multilingual_translator", "business_interpreter", "technical_translator", "medical_translator", "game_translator", "legal_translator"
        };
    ...
    private List<ExpertProfile> createExpertProfiles(List<Member> members, List<Specialization> specializations) {
        ...
        // 전문가별 프로필 데이터 배열들 (각 분야별 6명씩 총 30명)
        String[] introduceMessages = {
            ...
            // 디자인 (6-11)
            "사용자 중심의 직관적인 UI 디자인으로 앱과 웹의 사용성을 극대화하는 UI 디자이너입니다.",
            "UX 리서치부터 프로토타이핑까지, 사용자 경험을 설계하는 UX 디자인 전문가입니다.",
            ...
            "기업 법무팀 출신 변호사로 M&A, 계약 협상, 기업 컴플라이언스 전문가입니다.",
            // 번역/통역 (24-29)
        ...
        String[] portfolioDescriptions = {
            ...
            "대용량 트래픽 처리 서버 개발, MSA 아키텍처 설계 및 구축 경험, Spring Boot 전문성",
            "e-커머스 플랫폼 풀스택 개발, 월 거래액 100억 규모 서비스 구축 경험",
            "카카오뱅크, 토스 등 핀텍 앱 개발 참여, 앱스토어 TOP 10 앱 개발 경험",
            "네이버 검색 랭킹 알고리즘 개발 참여, 카카오 추천시스템 구축 경험",
            "업비트 거래소 스마트컨트랙트 개발, OpenSea NFT 마켓플레이스 개발 참여",
            // 디자인 분야 (6-11) - 총 6명
            "스타트업 UI 디자인 30개 이상, 사용자 테스트를 통한 사용성 50% 향상 성과",
            "앱스토어 1위 앱 UX 리서치 및 디자인, 사용자 경험 개선을 통한 DAU 300% 증가 사례",
            "코카콜라, 나이키 등 글로벌 브랜드 리브랜딩 프로젝트 참여, 브랜드 가치 20% 상승",
            "CJ제일제당 제품 패키지 디자인, 신세계백화점 VIP 카드 디자인 등 인쇄물 디자인 200건",
            "현대자동차 공식 홈페이지 리뉴얼, 배달의민족 랜딩페이지 제작 등 대규모 웹 디자인 경험",
            "현대모비스 자동차 부품 3D 모델링, 아이폰 제품 렌더링 작업 등 고퀄리티 3D 작업 경험",
        ...
        String[] majors = {
            // 프로그래밍 (0-5) - 6명
            "컴퓨터공학과", "소프트웨어학과", "정보통신공학과", "전자공학과", "데이터사이언스학과", "AI융합학과",
            // 디자인 (6-11) - 6명
            "시각디자인학과", "산업디자인학과", "브랜드디자인학과", "제품디자인학과", "커뮤니케이션디자인학과", "예술학과",
            // 영상편집 (12-17) - 6명
            "영상제작학과", "미디어커뮤니케이션학과", "방송영상학과", "디지털미디어학과", "영화학과", "콘텐츠학과",
            // 세무/법무/노무 (18-23) - 6명
            "회계학과", "법학과", "행정학과", "세무학과", "법학과", "경영학과",
            // 번역/통역 (24-29) - 6명
            "영어영문학과", "통번역학과", "국제통상학과", "일본어일문학과", "중국어중문학과", "국제학과"
        };
        
        // 전문분야별 인덱스 범위 정의 (각 분야별 6명씩)
        // 프로그래밍: 0-5, 디자인: 6-11, 영상편집: 12-17, 세무/법무/노무: 18-23, 번역/통역: 24-29
